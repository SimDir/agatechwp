...
function showBorderFirst() {
   document.querySelector('#header__menu_link_first').style.borderBottom ="3px solid #fff";
}
function hideBorderFirst() {
   document.querySelector('#header__menu_link_first').style.borderBottom ="none";
}
...
function showBorderTwo() {
   document.querySelector('#header__menu_link_two').style.borderBottom ="3px solid #fff";
}
function hideBorderTwo() {
   document.querySelector('#header__menu_link_two').style.borderBottom ="none";
}
...
function showBorderThree() {
   document.querySelector('#header__menu_link_three').style.borderBottom ="3px solid #fff";
}
function hideBorderThree() {
   document.querySelector('#header__menu_link_three').style.borderBottom ="none";
}
...
function showBorderFour() {
   document.querySelector('#header__menu_link_four').style.borderBottom ="3px solid #fff";
}
function hideBorderFour() {
   document.querySelector('#header__menu_link_four').style.borderBottom ="none";
}
...
function showBorderFive() {
   document.querySelector('#header__menu_link_five').style.borderBottom ="3px solid #fff";
}
